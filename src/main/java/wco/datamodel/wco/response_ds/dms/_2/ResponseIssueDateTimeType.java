...
@XmlType(name = "ResponseIssueDateTimeType", propOrder = {
    "dateTimeString"
})
public class ResponseIssueDateTimeType {

    @XmlElement(name = "DateTimeString")
    protected ResponseIssueDateTimeType.DateTimeString dateTimeString;
     ...
     * @return
     *     possible object is
     *     {@link ResponseIssueDateTimeType.DateTimeString }
     *     
     */
    public ResponseIssueDateTimeType.DateTimeString getDateTimeString() {
     ...
     *     
     */
    public void setDateTimeString(ResponseIssueDateTimeType.DateTimeString value) {
