...
/**
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;WCOID xmlns:udt="urn:un:unece:uncefact:data:standard:UnqualifiedDataType:6" xmlns:xs="http://www.w3.org/2001/XMLSchema"&gt;D015&lt;/WCOID&gt;
 * </pre>
 * 
 *         
 * <pre>
 ...
 * </pre>
 * 
 * <p>Java class for InvoiceIssueDateTimeType complex type</p>.
 * 
...
@XmlType(name = "InvoiceIssueDateTimeType", propOrder = {
    "dateTimeString"
})
public class InvoiceIssueDateTimeType {

    @XmlElement(name = "DateTimeString")
    protected InvoiceIssueDateTimeType.DateTimeString dateTimeString;
     ...
     * @return
     *     possible object is
     *     {@link InvoiceIssueDateTimeType.DateTimeString }
     *     
     */
    public InvoiceIssueDateTimeType.DateTimeString getDateTimeString() {
     ...
     *     
     */
    public void setDateTimeString(InvoiceIssueDateTimeType.DateTimeString value) {
