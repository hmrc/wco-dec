...
trait WcoSpec extends WordSpec with MustMatchers with ScalaFutures {
  ...
  protected def randomCancelDeclaration: MetaData = MetaData(
    ...
    declaration = Some(Declaration(
      ...
      additionalInformations = List(AdditionalInformation(
  ...
  private lazy val z: List[String] = List("+", "-")

  private lazy val declarationFunctionCodes: List[Int] = List(9, 13, 14)

  private lazy val dateTimeFormatCodes: List[String] = List("102", "304")

  private lazy val firstNames: List[String] = List("Oliver", "Jack", "Harry", "Jacob", "Charlie", "Thomas", "George", "Oscar", "James", "William", "Amelia", "Olivia", "Isla", "Emily", "Poppy", "Ava", "Isabella", "Jessica", "Lily", "Sophie")

  private lazy val lastNames: List[String] = List("Smith", "Jones", "Williams", "Brown", "Taylor", "Davies", "Wilson", "Evans", "Thomas", "Roberts")

  private lazy val tlds: List[String] = List(".com", ".org", ".net", ".co.uk", ".org.uk")
